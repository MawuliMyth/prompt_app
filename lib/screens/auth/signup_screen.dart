...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _openLegalPage(String url) async {
    ...
    if (!launched && mounted) {
      SnackbarUtils.showError(context, 'Unable to open this page.');
    }
  }
  ...
  Future<void> _handleSignup() async {
    ...
    if (success && mounted) {
      trackAnalytics(
        () => analyticsService.logSignUpCompleted(method: 'email'),
      );
  ...
  Future<void> _handleGoogleSignIn() async {
    ...
    if (success && mounted) {
      trackAnalytics(
        () => analyticsService.logSignUpCompleted(method: 'google'),
      );
      trackAnalytics(() => analyticsService.logGuestToUserConverted());
      PlatformUtils.navigateReplace(context, const HomeScreen());
    } else if (mounted && authProvider.error != null) {
  ...
  Future<void> _handleAppleSignIn() async {
    ...
    if (success && mounted) {
      trackAnalytics(
        () => analyticsService.logSignUpCompleted(method: 'apple'),
      );
      trackAnalytics(() => analyticsService.logGuestToUserConverted());
      PlatformUtils.navigateReplace(context, const HomeScreen());
    } else if (mounted && authProvider.error != null) {
              ...
              AdaptiveTextField(
                ...
                inputFormatters: [
                  TextInputFormatter.withFunction((oldValue, newValue) {
                    ...
                    final lengthDelta = formatted.length - newValue.text.length;
                    final targetOffset =
